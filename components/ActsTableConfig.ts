...
export const ALL_COLUMNS: { key: ActTableColumnKey; label: string; type: 'text' | 'date' | 'textarea' | 'custom_date' | 'materials', widthClass: string }[] = [
    ...
    { key: 'materials', label: '3. Материалы', type: 'materials', widthClass: 'w-80' },
